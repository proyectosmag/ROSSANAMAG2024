         ...
         <div className="">
            ...
            <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-4 lg:pb-24">
               ...
               <div className="mt-4 lg:row-span-3 lg:mt-0">
                  ...
                  <Link className="mt-4 group flex items-center justify-between rounded-lg border border-current px-5 py-3 text-dorado transition-colors  hover:bg-gradient-to-r hover:from-dorado hover:via-dorado-super-light hover:to-dorado active:bg-dorado"  href="mailto:rossana_ulloque@yahoo.es">
                     <span className="flex font-medium transition-colors group-hover:text-white">
                        <BsFillEnvelopeFill className="mr-4 mt-1" /> rossana_ulloque@yahoo.es
                     </span>
                     <span className="ml-4 flex-shrink-0 rounded-full border border-dorado bg-white p-2 group-active:border-dorado">
                        <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                           <path  strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
